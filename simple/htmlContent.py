import datetime
from simple import logo_base64, _simple


def html_content(column, digits, count, method, title):
    ...
    for i in range(count):
        res = _simple.simple(column=column, digits=digits, count=10, method=method)
...
if __name__ == "__main__":
    content = html_content(column=5, digits=1, count=10, method='mixed', title=f'shunchaki {datetime.datetime.now()}')
